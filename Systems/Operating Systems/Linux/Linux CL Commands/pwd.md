...
This is also known as your [[Tilde Home Directory]], a special place where you have control of files and other users normally have no access. This directory is usually named the same as your username and is located under the home directory.
...
The tilde *~* in your prompt is also indicating what the current directory is. The "shortcut" way to represent your [[Tilde Home Directory]]. 
