...
tags: []
---
When the [[ls]] cmd is used to show the contents of a directory, not all files are shown usually (it omits hidden files by default). A hidden file is any file that starts with a . 
